  ...
  return (
    <div className="p-8 max-w-[1400px] mx-auto text-gray-200">
      <div className="flex flex-col items-center justify-center h-[60vh] bg-[#09090b] border border-white/10 rounded-xl">
        ...
        <h1 className="text-2xl font-semibold text-white mb-2">Widgets Dashboard</h1>
        <p className="text-gray-400 text-center max-w-md">
          This section is currently being developed. Stay tuned for new features and updates for the Widgets module.
        </p>
      </div>
    </div>
  )
